...
Patrón copiado de src/_plantilla: se reutiliza UN solo `pulsar.Client` por
proceso y UN productor por (tópico, esquema). Antes el despachador abría y
cerraba un cliente por mensaje (handshake TCP + lookup + registro de esquema
en cada envío); aquí el cliente y los productores viven mientras viva el
proceso.
"""
import threading
