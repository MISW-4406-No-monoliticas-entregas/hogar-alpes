...
Mismo patrón que los otros 4 servicios. Sin main.py todavía en este slice
(ver README): quien arme el servicio completo llama `crear_tablas()` al
arrancar, igual que hacen los demás.
"""
...
def crear_tablas():
    ...
    from modulos.orquestador.infraestructura import dto as _dto_saga  # noqa: F401
